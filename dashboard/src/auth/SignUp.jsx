...
import { FaUser, FaUserShield, FaGoogle } from "react-icons/fa";
...
export default function SignUp({ onSwitch, theme = "light" }) {
  ...
  const inputClass =
    theme === "light"
      ...
      : "border-gray-700 placeholder-gray-400 text-white";
  const roleSelectedClass = "border-blue-600 bg-blue-50 text-blue-600";
  const roleUnselectedClass = theme === "light" ? "border-gray-200 text-gray-600" : "border-gray-700 text-gray-300";
