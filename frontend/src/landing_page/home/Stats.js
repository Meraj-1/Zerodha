        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-16">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-2xl font-bold text-gray-700 mb-2">Customer-first always</h4>
              ...
              <div>
                <h4 className="text-2xl font-bold text-gray-700 mb-2">No spam or gimmicks</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                <h4 className="text-2xl font-bold text-gray-700 mb-2">The Zerodha universe</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div>
                <h4 className="text-2xl font-bold text-gray-700 mb-2">Do better with money</h4>
                <p className="text-gray-600 leading-relaxed">
          ...
          <div className="lg:w-1/2 flex flex-col items-center space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-2">
              <a
                href="#"
                className="text-blue-600 font-semibold text-lg hover:underline transition"
              >
                Explore Our Product →
              </a>
              <a
