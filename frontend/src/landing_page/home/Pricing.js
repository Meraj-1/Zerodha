    ...
    <section className={`${t.bgSecondary} py-20`}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className={`${t.textSecondary} mt-4 text-lg max-w-3xl mx-auto`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Info Card */}
          <div className={`${t.bg} rounded-xl shadow-md p-8 text-center hover:shadow-lg transition`}>
          ...
          <div className={`${t.bg} rounded-xl shadow-md p-8 text-center hover:shadow-lg transition`}>
            ...
            <p className={`${t.textSecondary} font-semibold mt-4 text-lg`}>
