      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14 items-center">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h4 className="mt-6 text-3xl font-serif font-bold text-gray-900">
              Nithin Kamath
            </h4>
          ...
          <div className="md:col-span-2">
            <div className="space-y-5 text-lg text-gray-700 leading-relaxed">
              <p>
                ...
                <span className="font-semibold text-gray-900">Zerodha</span> in
              ...
              {/* Social Links */}
              <div className="pt-4">
                <span className="text-gray-600 mr-2">Connect on:</span>
                <a
